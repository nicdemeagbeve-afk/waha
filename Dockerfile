...
# --- DÉBUT DE LA CORRECTION POUR LA COMPILATION NATIVE (sqlite3, etc.) ---
# Installer les dépendances système nécessaires pour compiler sqlite3 et d'autres modules natifs
RUN apt-get update && \
